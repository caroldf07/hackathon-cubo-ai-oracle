...
class GeneticDataGenerator:
    def __init__(self, population_size=100):
        ...
        self.finops_data = pd.read_csv('synthetic_finops_data.csv')
        self.datadog_metrics = pd.read_csv('datadog_synthetic_metrics.csv')
...
def main():
    ...
    existing_data = pd.read_csv('synthetic_finops_data.csv')
    ...
    # Salvar resultados
    combined_data.to_csv('synthetic_finops_data_enhanced.csv', index=False)
